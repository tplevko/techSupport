...
public class AccountDaoImplTest {
    ...
    public void setUp() throws AddressException {
        ...
        // TODO 
        inetAddress = new InternetAddress("tomasplevko@gmail.com");
        
        account = new Account();
        account.setEmail(inetAddress);
...
//    @Test
    public void testFindAccountAccrodToId() {
        ...
        AccountDaoImpl instance = new AccountDaoImpl();
        Account expResult = null;
        Account result = instance.findAccountAccrodToId(id);
        assertEquals(expResult, result);
        // TODO review the generated test code and remove the default call to fail.
        fail("The test case is a prototype.");
    }
...
//    @Test
    public void testFindAccountAccordToName() {
        ...
        AccountDaoImpl instance = new AccountDaoImpl();
        Account expResult = null;
        Account result = instance.findAccountAccordToName(name);
        assertEquals(expResult, result);
        // TODO review the generated test code and remove the default call to fail.
        fail("The test case is a prototype.");
    }
...
//    @Test
    public void testFindAccountAccordToEmail() {
        ...
        AccountDaoImpl instance = new AccountDaoImpl();
        Account expResult = null;
        Account result = instance.findAccountAccordToEmail(email);
        assertEquals(expResult, result);
        // TODO review the generated test code and remove the default call to fail.
        fail("The test case is a prototype.");
    }
